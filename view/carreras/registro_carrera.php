<?php
  ...
  $controller_carrera = new MVC();
  //verificar si el usuario inicio sesion antes
  $controller_carrera->verificarLoginController();
  //registro de carrera al presionar el boton de registrar
  $controller_carrera->registroCarreraController();
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Registro de carrera</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <!-- left column -->
            ...
            <div class="card card-primary">
               <div class="card-header">
                        <h3 class="card-title">Por favor, Ingresa la información de la carrera</h3>
                </div>
              <!-- /.card-header -->
              <!-- form start -->
